...
It's literally just [@thinkclay's] (https://github.com/thinkclay/) original [obscenely useful EE2 plugin] (https://github.com/thinkclay/ExpressionEngine-Excerpt-Plugin), but modified to run on ExpressionEngine 3 and 4.
